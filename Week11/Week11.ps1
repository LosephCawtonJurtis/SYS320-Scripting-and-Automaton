...
# Check if location exists
    ...
    Get-FileHash -Path "C:\Users\joseph.lawtoncurtis\Desktop\Homework\week11output\outputData.zip" | select Hash, Path | Export-Csv -Path "C:\Users\joseph.lawtoncurtis\Desktop\Homework\week11output\CSData.csv"
